        ...
        <div class="card border-10 pt-2 card-primary">
            <div class="card-body">
                <div class="row pt-1 mt-1">
                    <form class="validate-form" action="{{ route('admin.add_product') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-lg-12 col-xl-12 mb-4">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="details" required class="form-control" data-parsley-required-message="Product details is required">{{ old('details') }}</textarea>
                                        @error('details')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
